...
describe('Deque', () => {
    ...
    it('should work for large data', () => {
        ...
        for(let i = 0; i < 1e4; i++) {
            ...
            if (num % 4 === 0) deque.push(num), arr.push(num)
            if (num % 4 === 1) deque.shift(num), arr.shift(num)
            if (num % 4 === 2) deque.unshift(num), arr.unshift(num)
            if (num % 4 === 3) deque.pop(num), arr.pop(num)
        }
