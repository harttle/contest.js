class RBTreeNode {
    ...
    hasRedChild() { 
        return (this.left && this.left.color === 0) || (this.right && this.right.color === 0)
    }
}
...
class RBTree {
    ...
    fixAfterInsert(pt) {
        ...
        while (pt !== this.root && pt.color !== 1 && pt.parent.color === 0) {
            ...
            if (parent_pt === grand_parent_pt.left) {
                let uncle_pt = grand_parent_pt.right
            ...
            /* Case : B 
               Parent of pt is right child of Grand-parent of pt */
                ...
                let uncle_pt = grand_parent_pt.left
    ...
    fixDoubleBlack(x) {
        ...
        let sibling = x.sibling(), parent = x.parent
        if (!sibling) {
